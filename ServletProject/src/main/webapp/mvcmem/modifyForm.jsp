...
<table border="1">
	<tr>
		<td colspan="2" align="center">회원 수정 정보 입력</td>   <!-- 타이틀 활용 -->
	</tr>
	...
	<tr>
		...
		<td>
			<input type="password" name="pass" value="value="${pass}">
		</td>
	</tr>	
	...
	<tr>
		...
		<td>
			<input type="password" name="repass" value="value="${pass}"> 
		</td>
	</tr>
	...
	<tr>
		...
		<input type="button" value="회원정보수정" onclick="inputCheck()">&nbsp;&nbsp;
